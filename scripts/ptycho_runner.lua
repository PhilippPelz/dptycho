...
local path = '/home/philipp/'
local file = 'simtest1e7.h5'
...
probe = probe:view(1,1,probe:size(1),probe:size(2))
object_solution = object_solution:view(1,1,object_solution:size(1),object_solution:size(2))
