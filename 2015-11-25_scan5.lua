...
local path = '/home/philipp/experiments/2015-11-25 oxford/scan5/'
local file = '2015-11-25_final_7.h5'
local probe_file = 'probe_neg4000.h5'
...
par = {
  ...
  save_interval = 5,
  save_path = path..'/hyperscan_final_7/'
}
