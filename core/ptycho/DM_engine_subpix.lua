...
function engine:iterate(steps)
  ...
  for i=1,steps do
    ...
    u.printf('%-10d%-15g%-15g%-15g%-15g%-15g%-15g',i,self.mod_errors[i] or -1,self.overlap_errors[i] or -1 ,self.img_errors[i] or -1, self.rel_errors[{i}] or -1, probe_error or -1, mod_updates/self.K*100.0)
